...
yum install iptables -y && policystatus=$?
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
yum install syslog-ng -y && systemctl enable syslog-ng
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
yum install epel-release -y && yum install rsyslog -y && yum install syslog-ng -y
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
